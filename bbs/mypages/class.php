...
.tab-content.active {
  ...
  <div class="contents-wrap" id="contents-class">
    <section class="tab-content active">
      <!-- 서브페이지 이미지 파일 -->
      <img class="tab-img" src="<?php echo G5_THEME_IMG_URL ?>/menu/class-cake.png" alt="케이크 수업 안내">
    </section>
    <section class="tab-content">
      <!-- 서브페이지 이미지 파일 -->
      <img class="tab-img" src="<?php echo G5_THEME_IMG_URL ?>/menu/class-coffee.png" alt="커피 수업 안내">
    </section>
  </div>
  <!-- contents end -->
