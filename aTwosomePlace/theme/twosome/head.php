...
color: #ffffff;
        ...
        <?}else{?>
            <!-- 메뉴 -->
              ...
              <nav class="sub-nav">
                <a href="http://teamtwosome.dothome.co.kr/theme/twosome/menu1.php" class="sub-tab <?if($s_menu == "01"){echo " active";}?>">케이크</a>
                <a href="http://teamtwosome.dothome.co.kr/theme/twosome/menu2.php" class="sub-tab <?if($s_menu == "02"){echo " active";}?>" style="border-left:0;">커피&음료</a>
