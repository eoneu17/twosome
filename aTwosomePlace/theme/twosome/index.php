...
#btn .prev{position: absolute;width: 100px;}
#btn .next{position: absolute;}
	...
	#text{width: 1920px;height:100px;padding-top:50px;}
...
* {
  ...
  #class-links .cake p{
   ...
   #class-links .coffee p{
    bottom:350px;left:35px;
...
<section id="slider_wrap">
	...
	<div id="btn">
	<img src="<?echo G5_THEME_IMG_URL?>/prev.png" alt="prev" class="prev">
	<img src="<?echo G5_THEME_IMG_URL?>/next.png" alt="next" class="next">
	</div>
</section> 
	

<div id="bar1">
<img src="<?echo G5_THEME_IMG_URL?>/section2-3.jpg" alt="bar1">
</div>
